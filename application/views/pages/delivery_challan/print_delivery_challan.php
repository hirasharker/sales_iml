...
<link href="<?php echo base_url();?>build/css/dc-print.css" rel="stylesheet" media="print">
<!-- jQuery -->
...
<div class="print-container" style="page-break-after: always;">
    ...
    <div class="content">
        <table class="customer-detail" border="0">
             <?php if($customer_detail->delivery_challan_no!=NULL){?>
            <tr>
                <td class="left no-print"><b>SL NO - <?php echo $customer_detail->delivery_challan_no;?></b></td>
            </tr>
            <?php }?>
            <tr>
                <td class="left no-print">DO ISSUE DATE</td>
                <td class="right"><?php echo $customer_detail->do_update_time;?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="left no-print">ADDRESS </td>
            ...
            <tr>
                <td class="left no-print">LC BANK</td>
                <td class="right"><?php 
                foreach ($bank_list as $b_value) {
                    if($b_value->bank_id==$customer_detail->lc_bank_id){
            ...
            <tr style="margin-bottom: 0px">
                ...
                <td class="right"><?php echo strtoupper($customer_detail->engine_no); ?></td>
            </tr>
            <tr>
                <td class="left no-print">CHASSIS NO </td>
                <td class="right"><?php echo strtoupper($customer_detail->chassis_no); ?></td>
            </tr>
            
            <?php if($customer_detail->vehicle_mfg_type == 1){?>
            <tr>
                <td class="left no-print">Type</td>
                <td><p>CBU</p></td>
            </tr>
            <?php } ?>

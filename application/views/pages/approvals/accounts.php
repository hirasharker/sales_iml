                        ...
                        <div class="x_panel">
                            ...
                            <table id="datatable-buttons1" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>50,000</td>
                                    <td>2017/10/25</td>
                                    <td><a href="#"><i class="fa fa-expand" aria-hidden="true" ></i> Detail</a> | <a href="#" style="color:#269414"><i class="fa fa-check" aria-hidden="true" ></i> Approve</a> <a href="#" style="color:#f00"><i class="fa fa-times" aria-hidden="true" ></i> Deny</a></td>
                                </tr>
                                <tr>
                            ...
                            <div class="x_title">
                                ...
                                <table id="datatable-buttons3" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>50,000</td>
                                        <td>2017/10/25</td>
                                        <td><a href="#"><i class="fa fa-expand" aria-hidden="true" ></i> Detail</a></td>
                                    </tr>
                                    <tr>
                                        <td>00-00-000-000-00002</td>
                                        <td>Md. Kalim Uddin</td>

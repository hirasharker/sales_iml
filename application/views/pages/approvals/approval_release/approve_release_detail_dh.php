<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form action="<?php echo base_url();?>approval_release/approve_divisional_head" method="post" enctype='multipart/form-data'>
            ...
            <div id="modalContent">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                        <th scope="row">Proposed Collection Amount (RO)</th>
                        ...
                        <tr>
                        <th scope="row">Proposed Collection Amount by Divisional Head </th>
                        <td><input type="number" class="col-md-12 col-sm-12 col-xs-12" name="proposed_collection_amount_by_dh" required min="0"></td>
                        </tr>

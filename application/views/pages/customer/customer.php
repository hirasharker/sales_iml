      ...
      <?php if($customer_id == NULL){?>
        ...
        <div class="x_panel">
            ...
            <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>customer/update_customer/" enctype='multipart/form-data'>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">First Mobile No </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Second Mobile No (Optional) </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input id="phone" type="text" class="form-control" name="phone2" placeholder="" value="<?php echo $customer_detail->phone2; ?>">
                  </div>
                </div>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" name="chassis_no" value="<?php echo $customer_detail->chassis_no; ?>" placeholder="" readonly>
                  </div>
                </div>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Engine No </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" name="engine_no" value="<?php echo $customer_detail->engine_no; ?>" placeholder="" readonly>
                  </div>
                </div>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <input type="hidden" name="model_id" value="<?php echo $customer_detail->model_id ?>">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Model Code </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    <?php foreach($model_list as $m_value){ if ($customer_detail->model_id == $m_value->model_id){?>
                      <input type="text" class="form-control" name="model_code" value="<?php echo $m_value->model_code.' - '.$m_value->model_name; ?>" placeholder="" readonly>
                    <?php }} ?>
                  </div>
                </div>

            ...
            <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>customer/add_customer/" enctype='multipart/form-data'>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <option value="NULL" permanentAddress="none">none</option>
                      <?php foreach($reference_list as $value){?>
                      <!-- <option customerName="<?php echo $value->CustName; ?>" fatherName="<?php echo $value->FathersName; ?>" motherName="<?php echo $value->MothersName; ?>" permanentAddress="<?php echo $value->PermanentAddress; ?>" presentAddress="<?php echo $value->PresentAddress; ?>" value="<?php echo $value->CustCode; ?>"><?php echo $value->CustCode; ?></option> -->
                      <option customerName="<?php echo $value->CustName; ?>" fatherName="<?php echo $value->FathersName; ?>" motherName="<?php echo $value->MothersName; ?>" value="<?php echo $value->CustCode; ?>"><?php echo $value->CustCode; ?></option>
                      <?php }?>
                      </select>
                  </div>
                </div>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="number" class="form-control" name="national_id" placeholder="">
                  </div>
                </div>
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="file" class="form-control" name="nid_file" placeholder="" required>
                  </div>
                </div>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <select class="form-control select-tag" name="mkt_id" required>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Business Address (optional)</span>
                  </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Spouse's Address (optional)</span>
                  </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input id="totalPrice" type="text" class="form-control" name="total_price" placeholder="" required>
                  </div>
                </div>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input id="downpayment" type="text" class="form-control" name="downpayment" placeholder="" required>
                  </div>
                </div>
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input id="interestRate" type="text" class="form-control" name="interest_rate" placeholder="" required>
                  </div>
                </div>
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Installment Starts from </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="number" class="form-control" name="installment_start_date" placeholder="" value="60" required>
                  </div>
                </div>
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Discount </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input id="discount" type="text" class="form-control" name="discount" placeholder="" required>
                  </div>
                </div>

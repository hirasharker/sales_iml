	...
	<div class="col-md-12">
        <div class="card"><!-- Nav tabs -->
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#waiting-for-clearence" aria-controls="waiting-for-clearence" role="tab" data-toggle="tab">Waiting for Pringting Delivery Order</a></li>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="waiting-for-clearence">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                            <h4>Pending List for Delivery Order<small></small></h2>
                            ...
                            <!-- <p class="text-muted font-13 m-b-30">
                                ...
                                <table id="datatable-buttons1" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>2017/12/25</td>
                                        <td><a href="#"><i class="fa fa-print"></i> print</a></td>
                                    </tr>
                                    <tr>

...
<div class="">
  <div class="page-title">
    <div class="title_left">
      <h3>Service Report <small></small></h3>
    </div>
                ...
                <script>
                  $(function() { 
                      ...
                      $("#generate").click(function(){ 
                          ...
                          $.ajax({
                                  type: "POST",
                                  url: "<?php echo base_url()?>seize_report/generate_service_report/",
                                  data: { 'zone_id': zoneId, 'rm_id' : rmId, 'zm_id' : zmId, 'depot_id': svdId, 'start_date': startDate, 'end_date': endDate },

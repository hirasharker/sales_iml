...
class seize_Model extends CI_Model {
    ...
    public function get_seize_by_search_key($search_key){
        $this->db->select('tbl_seize.*, tbl_customer.customer_name, tbl_customer.city_id, tbl_customer.zhead_id, tbl_customer.dealer_id, tbl_customer.seize_status, tbl_customer.resale_status, tbl_customer.stock_id, tbl_city.rm_id, tbl_seize_depot.depot_name');
        $this->db->from('tbl_seize');
